...
import { Paper, Grid, Button, Box, Stack, Chip, Pagination, IconButton, Typography } from '@mui/material';
...
export default function () {
  ...
  useEffect(() => {
    try {
      new ToSupplierApiDocument().getDocumentsList(pageSelected, search, orderBy).then((response) => {
