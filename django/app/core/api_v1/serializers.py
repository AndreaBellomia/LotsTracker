...
class WarehouseItemsDocumentCustomerSerializer(serializers.ModelSerializer):
    ...
    item_type_description = serializers.StringRelatedField(source="item_type.description")
    item_type_code = serializers.StringRelatedField(source="item_type.internal_code")
...
class DocumentCustomerSerializer(serializers.ModelSerializer):
    status = serializers.StringRelatedField(source="document_status")
    body = WarehouseItemsDocumentCustomerSerializer(
    ...
    detail_url = serializers.HyperlinkedIdentityField(view_name='document-detail', source="id")
